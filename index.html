...
body{
    background:linear-gradient(to bottom,#050816,#0a1931,#102542);
    color:white;
    overflow-x:hidden;
}
...
<header>
    <img src="fotoku.jpg" alt="Foto Profil" class="profile-pic">

    <h1>Wulan Permata Sari</h1>

    <p class="subtitle">
        Pelajar • Pembelajar Teknologi • Pencinta Kreativitas
    </p>

    <a href="#tentang" class="btn">Jelajahi Profil</a>
</header>
...
<section id="tentang">
    ...
    <div class="card">
        ...
        <div class="skills">
            ...
            <div class="skill">Desain</div>
            <div class="skill">Belajar AI</div>
        </div>
    </div>
...
<footer>
    © 2026 | Website Pribadi Wulan Permata Sari
</footer>
